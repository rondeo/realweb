...
<div class="tv-container">
		...
		<div class="tv-item">
			...
			<div class="tv-itemTitleContainer">
				<div class="tv-itemIcon">
					<i class="icon-internet-tv"></i>
				</div>
				<div class="tv-itemTitle">
					<h3 class="tv-itemName" data-item-name="<?php the_field("tv-tarif-name"); ?>"><?php the_field("tv-tarif-name"); ?></h3>
					<p><?php the_field("tv-tarif-short-text"); ?></p>
				</div>
			</div>
			...
			<div class="tv-itemPriceContainer">
					...
					<div class="tv-itemPrice">
						<span class="tv-itemPriceNumber" data-price="<?php the_field("tv-tarif-price"); ?>"><?php the_field("tv-tarif-price"); ?></span>
			...
			<div class="tv-itemAddContainer">
				...
				<div class="iswitcherAddItem">
					...
					<p>Добавить</p>						
					<div class="iswitcherPlate" data-item-type="serv-item-plate" data-item-name="<?php the_field("tv-tarif-name"); ?>">							
		...
		<div class="tv-itemChannelsListContainer">
			<div><?php the_field("tv-tarif-channels-list"); ?></div>
		</div>
